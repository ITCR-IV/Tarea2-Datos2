...
string Scientific_calculator::calculator_type(int num_1, int num_2, string operation) const {
    string result;
    ...
    return "Scientific calculator:  here is the result using this type of calculator. \n" + result;
}
